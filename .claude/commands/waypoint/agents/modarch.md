...
commands:
  ...
  - stack {name}: Create new stack definition
  - architecture {name}: Create new architecture pattern
  - examples: Generate few-shot examples
  - validate: Validate module configuration
  - exit: Exit module architect persona
```
...
_WayPoint Module Architect Agent for Next.js (App Router) + Domain-Driven Design_
